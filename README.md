...
plt.bar(nodes - bar_width/2, authority, bar_width, label='Authority', color='skyblue')  # Change color to sky blue
plt.bar(nodes + bar_width/2, hub, bar_width, label='Hub', color='lightgreen')  # Change color to light green
plt.xlabel('Node')
plt.ylabel('Scores')
...
### Output:
![image](https://github.com/kavyasenthamarai/WDM_EXP7/assets/118668727/51082337-f786-427b-b726-a678598abbfb)
